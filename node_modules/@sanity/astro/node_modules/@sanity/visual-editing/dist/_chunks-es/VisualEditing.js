...
const isReactElementOverlayComponent = (component) => isValidElement(component), Root$3 = styled(Card).withConfig({
  displayName: "Root",
  componentId: "sc-e95gnt-0"
})`background-color:var(--overlay-bg);border-radius:3px;pointer-events:none;position:absolute;will-change:transform;box-shadow:var(--overlay-box-shadow);transition:none;--overlay-bg:transparent;--overlay-box-shadow:inset 0 0 0 1px transparent;[data-overlays] &{--overlay-bg:color-mix(in srgb,transparent 95%,var(--card-focus-ring-color));--overlay-box-shadow:inset 0 0 0 2px color-mix(in srgb,transparent 50%,var(--card-focus-ring-color));}[data-fading-out] &{transition:box-shadow 1550ms,background-color 1550ms;--overlay-bg:rgba(0,0,255,0);--overlay-box-shadow:inset 0 0 0 1px transparent;}&[data-focused]{--overlay-box-shadow:inset 0 0 0 1px var(--card-focus-ring-color);}&[data-hovered]:not([data-focused]){transition:none;--overlay-box-shadow:inset 0 0 0 2px var(--card-focus-ring-color);}:link{text-decoration:none;}`, Actions = styled(Flex).withConfig({
  displayName: "Actions",
  componentId: "sc-e95gnt-1"
})`bottom:100%;cursor:pointer;pointer-events:none;position:absolute;right:0;[data-hovered]:not([data-menu-open]) &{pointer-events:all;}[data-flipped] &{bottom:auto;top:100%;}`, HUD = styled(Flex).withConfig({
  displayName: "HUD",
  componentId: "sc-e95gnt-2"
})`top:100%;cursor:pointer;pointer-events:none;position:absolute;left:0;gap:4px;padding:4px 0;flex-wrap:wrap;[data-hovered]:not([data-menu-open]) &{pointer-events:all;}[data-flipped] &{top:calc(100% + 2rem);}`, MenuWrapper = styled(Flex).withConfig({
  displayName: "MenuWrapper",
  componentId: "sc-e95gnt-3"
})`margin:-0.5rem;[data-hovered]:not([data-menu-open]) &{pointer-events:all;}`, Tab = styled(Flex).withConfig({
  displayName: "Tab",
  componentId: "sc-e95gnt-4"
})`bottom:100%;cursor:pointer;pointer-events:none;position:absolute;left:0;[data-hovered]:not([data-menu-open]) &{pointer-events:all;}[data-flipped] &{bottom:auto;top:100%;}`, ActionOpen = styled(Card).withConfig({
  displayName: "ActionOpen",
  componentId: "sc-e95gnt-5"
})`cursor:pointer;background-color:var(--card-focus-ring-color);right:0;border-radius:3px;& [data-ui='Text']{color:#fff;white-space:nowrap;}`, Labels = styled(Flex).withConfig({
  displayName: "Labels",
  componentId: "sc-e95gnt-6"
})`display:flex;align-items:center;background-color:var(--card-focus-ring-color);right:0;border-radius:3px;& [data-ui='Text'],& [data-sanity-icon]{color:#fff;white-space:nowrap;}`, ExclusivePluginContainer = styled.div.withConfig({
...
function usePerspectiveSync(comlink2, dispatch, onPerspectiveChange) {
  const $ = c(11), handlesPerspectiveChange = !!onPerspectiveChange;
  let t0;
  ...
  let t1;
  $[3] !== comlink2 || $[4] !== handlePerspective || $[5] !== handlesPerspectiveChange ? (t1 = () => {
  ...
  }, $[3] = comlink2, $[4] = handlePerspective, $[5] = handlesPerspectiveChange, $[6] = t1) : t1 = $[6];
  let t2;
  $[7] !== comlink2 || $[8] !== dispatch || $[9] !== handlesPerspectiveChange ? (t2 = [comlink2, dispatch, handlesPerspectiveChange], $[7] = comlink2, $[8] = dispatch, $[9] = handlesPerspectiveChange, $[10] = t2) : t2 = $[10], useEffect(t1, t2);
}
function _temp$5() {
}
...
function useReportDocuments(comlink2, elements, perspective) {
  ...
  $[2] !== elements || $[3] !== perspective || $[4] !== reportDocuments ? (t1 = () => {
    ...
    if (!lastOrderedIds || lastOrderedIds.length !== orderedIds.length || orderedIds.some((id, index) => id !== lastOrderedIds[index]) || perspective !== lastReported.current?.perspective) {
