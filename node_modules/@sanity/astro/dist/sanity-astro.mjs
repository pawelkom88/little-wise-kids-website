import { createRequire as Ar } from "node:module";
import Br from "node:path";
var pr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Tr(u) {
  return u && u.__esModule && Object.prototype.hasOwnProperty.call(u, "default") ? u.default : u;
}
var K = { exports: {} }, Z = { exports: {} }, ir = {}, G = {}, dr;
function Pr() {
  if (dr) return G;
  dr = 1, G.byteLength = o, G.toByteArray = S, G.fromByteArray = P;
  for (var u = [], s = [], f = typeof Uint8Array < "u" ? Uint8Array : Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", m = 0, d = h.length; m < d; ++m)
    u[m] = h[m], s[h.charCodeAt(m)] = m;
  s[45] = 62, s[95] = 63;
  function l(p) {
    var w = p.length;
    if (w % 4 > 0)
  ...
  function S(p) {
    var w, y = l(p), B = y[0], b = y[1], k = new f(x(p, B, b)), L = 0, q = b > 0 ? B - 4 : B, F;
    for (F = 0; F < q; F += 4)
      w = s[p.charCodeAt(F)] << 18 | s[p.charCodeAt(F + 1)] << 12 | s[p.charCodeAt(F + 2)] << 6 | s[p.charCodeAt(F + 3)], k[L++] = w >> 16 & 255, k[L++] = w >> 8 & 255, k[L++] = w & 255;
    return b === 2 && (w = s[p.charCodeAt(F)] << 2 | s[p.charCodeAt(F + 1)] >> 4, k[L++] = w & 255), b === 1 && (w = s[p.charCodeAt(F)] << 10 | s[p.charCodeAt(F + 1)] << 4 | s[p.charCodeAt(F + 2)] >> 2, k[L++] = w >> 8 & 255, k[L++] = w & 255), k;
  }
  function A(p) {
    return u[p >> 18 & 63] + u[p >> 12 & 63] + u[p >> 6 & 63] + u[p & 63];
  }
  function C(p, w, y) {
    for (var B, b = [], k = w; k < y; k += 3)
      B = (p[k] << 16 & 16711680) + (p[k + 1] << 8 & 65280) + (p[k + 2] & 255), b.push(A(B));
    return b.join("");
  }
  function P(p) {
    for (var w, y = p.length, B = y % 3, b = [], k = 16383, L = 0, q = y - B; L < q; L += k)
      b.push(C(p, L, L + k > q ? q : L + k));
    return B === 1 ? (w = p[y - 1], b.push(
      u[w >> 2] + u[w << 4 & 63] + "=="
    )) : B === 2 && (w = (p[y - 2] << 8) + p[y - 1], b.push(
      u[w >> 10] + u[w >> 4 & 63] + u[w << 2 & 63] + "="
    )), b.join("");
  }
  return G;
}
...
var yr;
function Mr() {
  return yr || (yr = 1, Q.read = function(u, s, f, h, m) {
    var d, l, o = m * 8 - h - 1, x = (1 << o) - 1, S = x >> 1, A = -7, C = f ? m - 1 : 0, P = f ? -1 : 1, p = u[s + C];
    for (C += P, d = p & (1 << -A) - 1, p >>= -A, A += o; A > 0; d = d * 256 + u[s + C], C += P, A -= 8)
      ;
    for (l = d & (1 << -A) - 1, d >>= -A, A += h; A > 0; l = l * 256 + u[s + C], C += P, A -= 8)
      ;
    if (d === 0)
      d = 1 - S;
    else {
      if (d === x)
        return l ? NaN : (p ? -1 : 1) * (1 / 0);
      l = l + Math.pow(2, h), d = d - S;
    }
    return (p ? -1 : 1) * l * Math.pow(2, d - h);
  }, Q.write = function(u, s, f, h, m, d) {
    var l, o, x, S = d * 8 - m - 1, A = (1 << S) - 1, C = A >> 1, P = m === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = h ? 0 : d - 1, w = h ? 1 : -1, y = s < 0 || s === 0 && 1 / s < 0 ? 1 : 0;
    for (s = Math.abs(s), isNaN(s) || s === 1 / 0 ? (o = isNaN(s) ? 1 : 0, l = A) : (l = Math.floor(Math.log(s) / Math.LN2), s * (x = Math.pow(2, -l)) < 1 && (l--, x *= 2), l + C >= 1 ? s += P / x : s += P * Math.pow(2, 1 - C), s * x >= 2 && (l++, x /= 2), l + C >= A ? (o = 0, l = A) : l + C >= 1 ? (o = (s * x - 1) * Math.pow(2, m), l = l + C) : (o = s * Math.pow(2, C - 1) * Math.pow(2, m), l = 0)); m >= 8; u[f + p] = o & 255, p += w, o /= 256, m -= 8)
      ;
    for (l = l << m | o, S += m; S > 0; u[f + p] = l & 255, p += w, l /= 256, S -= 8)
      ;
    u[f + p - w] |= y * 128;
  }), Q;
}
...
var mr;
function Dr() {
  return mr || (mr = 1, (function(u) {
    var s = Pr(), f = Mr(), h = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
    u.Buffer = o, u.SlowBuffer = k, u.INSPECT_MAX_BYTES = 50;
    var m = 2147483647;
    u.kMaxLength = m, o.TYPED_ARRAY_SUPPORT = d(), !o.TYPED_ARRAY_SUPPORT && typeof console < "u" && typeof console.error == "function" && console.error(
    ...
    function x(t, r, e) {
      ...
      if (O(t, ArrayBuffer) || t && O(t.buffer, ArrayBuffer) || typeof SharedArrayBuffer < "u" && (O(t, SharedArrayBuffer) || t && O(t.buffer, SharedArrayBuffer)))
        return y(t, r, e);
      if (typeof t == "number")
        throw new TypeError(
    ...
    function A(t, r, e) {
      return S(t), t <= 0 ? l(t) : r !== void 0 ? typeof e == "string" ? l(t).fill(r, e) : l(t).fill(r) : l(t);
    }
    o.alloc = function(t, r, e) {
      return A(t, r, e);
    };
    function C(t) {
      return S(t), l(t < 0 ? 0 : b(t) | 0);
    }
    ...
    function P(t, r) {
      ...
      var e = L(t, r) | 0, n = l(e), i = n.write(t, r);
      return i !== e && (n = n.slice(0, i)), n;
    }
    function p(t) {
      for (var r = t.length < 0 ? 0 : b(t.length) | 0, e = l(r), n = 0; n < r; n += 1)
        e[n] = t[n] & 255;
      return e;
    }
    function w(t) {
    ...
    function B(t) {
      if (o.isBuffer(t)) {
        var r = b(t.length) | 0, e = l(r);
        return e.length === 0 || t.copy(e, 0, 0, r), e;
      }
      if (t.length !== void 0)
        return typeof t.length != "number" || nr(t.length) ? l(0) : p(t);
    ...
    o.isBuffer = function(r) {
      ...
      if (O(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), O(e, Uint8Array) && (e = o.from(e, e.offset, e.byteLength)), !o.isBuffer(r) || !o.isBuffer(e))
        throw new TypeError(
          'The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array'
        );
      if (r === e) return 0;
      for (var n = r.length, i = e.length, a = 0, c = Math.min(n, i); a < c; ++a)
        if (r[a] !== e[a]) {
          n = r[a], i = e[a];
          break;
        }
      ...
      if (e === void 0)
        for (e = 0, n = 0; n < r.length; ++n)
          e += r[n].length;
      var i = o.allocUnsafe(e), a = 0;
      for (n = 0; n < r.length; ++n) {
        var c = r[n];
        if (O(c, Uint8Array))
          a + c.length > i.length ? o.from(c).copy(i, a) : Uint8Array.prototype.set.call(
            i,
            c,
            a
          );
    ...
    o.prototype.swap16 = function() {
      ...
      var r = this.length;
      return r === 0 ? "" : arguments.length === 0 ? _(this, 0, r) : q.apply(this, arguments);
    ...
    }, h && (o.prototype[h] = o.prototype.inspect), o.prototype.compare = function(r, e, n, i, a) {
      if (O(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), !o.isBuffer(r))
        throw new TypeError(
          'The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof r
        );
      if (e === void 0 && (e = 0), n === void 0 && (n = r ? r.length : 0), i === void 0 && (i = 0), a === void 0 && (a = this.length), e < 0 || n > r.length || i < 0 || a > this.length)
      ...
      if (e >= n)
        return 1;
      if (e >>>= 0, n >>>= 0, i >>>= 0, a >>>= 0, this === r) return 0;
      for (var c = a - i, E = n - e, v = Math.min(c, E), I = this.slice(i, a), M = r.slice(e, n), U = 0; U < v; ++U)
        if (I[U] !== M[U]) {
          c = I[U], E = M[U];
          break;
        }
    ...
    function j(t, r, e, n, i) {
      ...
      if (typeof e == "string" ? (n = e, e = 0) : e > 2147483647 ? e = 2147483647 : e < -2147483648 && (e = -2147483648), e = +e, nr(e) && (e = i ? 0 : t.length - 1), e < 0 && (e = t.length + e), e >= t.length) {
        if (i) return -1;
        e = t.length - 1;
      } else if (e < 0)
        if (i) e = 0;
      ...
      if (typeof r == "string" && (r = o.from(r, n)), o.isBuffer(r))
        return r.length === 0 ? -1 : $(t, r, e, n, i);
      if (typeof r == "number")
        return r = r & 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(t, r, e) : Uint8Array.prototype.lastIndexOf.call(t, r, e) : $(t, [r], e, n, i);
      throw new TypeError("val must be string, number or Buffer");
    }
    function $(t, r, e, n, i) {
      var a = 1, c = t.length, E = r.length;
      ...
      function v(lr, hr) {
        return a === 1 ? lr[hr] : lr.readUInt16BE(hr * a);
      }
      var I;
      if (i) {
        var M = -1;
        for (I = e; I < c; I++)
          if (v(t, I) === v(r, M === -1 ? 0 : I - M)) {
            if (M === -1 && (M = I), I - M + 1 === E) return M * a;
          } else
            M !== -1 && (I -= I - M), M = -1;
      } else
        for (e + E > c && (e = c - E), I = e; I >= 0; I--) {
          for (var U = !0, X = 0; X < E; X++)
            if (v(t, I + X) !== v(r, X)) {
              U = !1;
              break;
            }
    ...
    o.prototype.includes = function(r, e, n) {
      ...
      return j(this, r, e, n, !0);
    }, o.prototype.lastIndexOf = function(r, e, n) {
      return j(this, r, e, n, !1);
    };
    function H(t, r, e, n) {
      e = Number(e) || 0;
      var i = t.length - e;
      ...
      n > a / 2 && (n = a / 2);
      for (var c = 0; c < n; ++c) {
        var E = parseInt(r.substr(c * 2, 2), 16);
        if (nr(E)) return c;
        t[e + c] = E;
      }
      return c;
    ...
    function V(t, r, e, n) {
      return Y(tr(r, t.length - e), t, e, n);
    }
    function rr(t, r, e, n) {
      return Y(br(r), t, e, n);
    }
    ...
    function N(t, r, e, n) {
      return Y(_r(r, t.length - e), t, e, n);
    }
    o.prototype.write = function(r, e, n, i) {
      ...
      var a = this.length - e;
      if ((n === void 0 || n > a) && (n = a), r.length > 0 && (n < 0 || e < 0) || e > this.length)
    ...
    function _(t, r, e) {
      ...
      for (var n = [], i = r; i < e; ) {
        var a = t[i], c = null, E = a > 239 ? 4 : a > 223 ? 3 : a > 191 ? 2 : 1;
        if (i + E <= e) {
          var v, I, M, U;
          switch (E) {
            case 1:
              ...
              break;
            case 2:
              v = t[i + 1], (v & 192) === 128 && (U = (a & 31) << 6 | v & 63, U > 127 && (c = U));
              break;
            case 3:
              v = t[i + 1], I = t[i + 2], (v & 192) === 128 && (I & 192) === 128 && (U = (a & 15) << 12 | (v & 63) << 6 | I & 63, U > 2047 && (U < 55296 || U > 57343) && (c = U));
              break;
            case 4:
              v = t[i + 1], I = t[i + 2], M = t[i + 3], (v & 192) === 128 && (I & 192) === 128 && (M & 192) === 128 && (U = (a & 15) << 18 | (v & 63) << 12 | (I & 63) << 6 | M & 63, U > 65535 && U < 1114112 && (c = U));
          }
        }
        c === null ? (c = 65533, E = 1) : c > 65535 && (c -= 65536, n.push(c >>> 10 & 1023 | 55296), c = 56320 | c & 1023), n.push(c), i += E;
      }
      return R(n);
    }
    var g = 4096;
    ...
    function kr(t, r, e) {
      for (var n = t.slice(r, e), i = "", a = 0; a < n.length - 1; a += 2)
    ...
    o.prototype.readUintLE = o.prototype.readUIntLE = function(r, e, n) {
      r = r >>> 0, e = e >>> 0, n || T(r, e, this.length);
      for (var i = this[r], a = 1, c = 0; ++c < e && (a *= 256); )
        i += this[r + c] * a;
      return i;
      ...
      return r = r >>> 0, e || T(r, 1, this.length), this[r];
    }, o.prototype.readUint16LE = o.prototype.readUInt16LE = function(r, e) {
      return r = r >>> 0, e || T(r, 2, this.length), this[r] | this[r + 1] << 8;
    }, o.prototype.readUint16BE = o.prototype.readUInt16BE = function(r, e) {
      return r = r >>> 0, e || T(r, 2, this.length), this[r] << 8 | this[r + 1];
    }, o.prototype.readUint32LE = o.prototype.readUInt32LE = function(r, e) {
      return r = r >>> 0, e || T(r, 4, this.length), (this[r] | this[r + 1] << 8 | this[r + 2] << 16) + this[r + 3] * 16777216;
    }, o.prototype.readUint32BE = o.prototype.readUInt32BE = function(r, e) {
      return r = r >>> 0, e || T(r, 4, this.length), this[r] * 16777216 + (this[r + 1] << 16 | this[r + 2] << 8 | this[r + 3]);
    }, o.prototype.readIntLE = function(r, e, n) {
      r = r >>> 0, e = e >>> 0, n || T(r, e, this.length);
      for (var i = this[r], a = 1, c = 0; ++c < e && (a *= 256); )
        i += this[r + c] * a;
      return a *= 128, i >= a && (i -= Math.pow(2, 8 * e)), i;
    }, o.prototype.readIntBE = function(r, e, n) {
      r = r >>> 0, e = e >>> 0, n || T(r, e, this.length);
      for (var i = e, a = 1, c = this[r + --i]; i > 0 && (a *= 256); )
        c += this[r + --i] * a;
      return a *= 128, c >= a && (c -= Math.pow(2, 8 * e)), c;
    }, o.prototype.readInt8 = function(r, e) {
      return r = r >>> 0, e || T(r, 1, this.length), this[r] & 128 ? (255 - this[r] + 1) * -1 : this[r];
    }, o.prototype.readInt16LE = function(r, e) {
      r = r >>> 0, e || T(r, 2, this.length);
      ...
      return r = r >>> 0, e || T(r, 4, this.length), this[r] | this[r + 1] << 8 | this[r + 2] << 16 | this[r + 3] << 24;
    }, o.prototype.readInt32BE = function(r, e) {
      return r = r >>> 0, e || T(r, 4, this.length), this[r] << 24 | this[r + 1] << 16 | this[r + 2] << 8 | this[r + 3];
    }, o.prototype.readFloatLE = function(r, e) {
      return r = r >>> 0, e || T(r, 4, this.length), f.read(this, r, !0, 23, 4);
    }, o.prototype.readFloatBE = function(r, e) {
      return r = r >>> 0, e || T(r, 4, this.length), f.read(this, r, !1, 23, 4);
    }, o.prototype.readDoubleLE = function(r, e) {
      return r = r >>> 0, e || T(r, 8, this.length), f.read(this, r, !0, 52, 8);
    }, o.prototype.readDoubleBE = function(r, e) {
      return r = r >>> 0, e || T(r, 8, this.length), f.read(this, r, !1, 52, 8);
    };
    ...
    o.prototype.writeUintLE = o.prototype.writeUIntLE = function(r, e, n, i) {
      ...
      var c = n - 1, E = 1;
      for (this[e + c] = r & 255; --c >= 0 && (E *= 256); )
        this[e + c] = r / E & 255;
      return e + n;
    }, o.prototype.writeUint8 = o.prototype.writeUInt8 = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 1, 255, 0), this[e] = r & 255, e + 1;
    }, o.prototype.writeUint16LE = o.prototype.writeUInt16LE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 2, 65535, 0), this[e] = r & 255, this[e + 1] = r >>> 8, e + 2;
    }, o.prototype.writeUint16BE = o.prototype.writeUInt16BE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 2, 65535, 0), this[e] = r >>> 8, this[e + 1] = r & 255, e + 2;
    }, o.prototype.writeUint32LE = o.prototype.writeUInt32LE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 4, 4294967295, 0), this[e + 3] = r >>> 24, this[e + 2] = r >>> 16, this[e + 1] = r >>> 8, this[e] = r & 255, e + 4;
    }, o.prototype.writeUint32BE = o.prototype.writeUInt32BE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 4, 4294967295, 0), this[e] = r >>> 24, this[e + 1] = r >>> 16, this[e + 2] = r >>> 8, this[e + 3] = r & 255, e + 4;
      ...
      var c = 0, E = 1, v = 0;
      for (this[e] = r & 255; ++c < n && (E *= 256); )
        r < 0 && v === 0 && this[e + c - 1] !== 0 && (v = 1), this[e + c] = (r / E >> 0) - v & 255;
      return e + n;
      ...
      return r = +r, e = e >>> 0, n || D(this, r, e, 1, 127, -128), r < 0 && (r = 255 + r + 1), this[e] = r & 255, e + 1;
    }, o.prototype.writeInt16LE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 2, 32767, -32768), this[e] = r & 255, this[e + 1] = r >>> 8, e + 2;
    }, o.prototype.writeInt16BE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 2, 32767, -32768), this[e] = r >>> 8, this[e + 1] = r & 255, e + 2;
    }, o.prototype.writeInt32LE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 4, 2147483647, -2147483648), this[e] = r & 255, this[e + 1] = r >>> 8, this[e + 2] = r >>> 16, this[e + 3] = r >>> 24, e + 4;
    }, o.prototype.writeInt32BE = function(r, e, n) {
      return r = +r, e = e >>> 0, n || D(this, r, e, 4, 2147483647, -2147483648), r < 0 && (r = 4294967295 + r + 1), this[e] = r >>> 24, this[e + 1] = r >>> 16, this[e + 2] = r >>> 8, this[e + 3] = r & 255, e + 4;
    };
    function ur(t, r, e, n, i, a) {
      if (e + n > t.length) throw new RangeError("Index out of range");
      if (e < 0) throw new RangeError("Index out of range");
    }
    function sr(t, r, e, n, i) {
      return r = +r, e = e >>> 0, i || ur(t, r, e, 4), f.write(t, r, e, n, 23, 4), e + 4;
    }
    o.prototype.writeFloatLE = function(r, e, n) {
      return sr(this, r, e, !0, n);
    }, o.prototype.writeFloatBE = function(r, e, n) {
      return sr(this, r, e, !1, n);
    };
    function cr(t, r, e, n, i) {
      return r = +r, e = e >>> 0, i || ur(t, r, e, 8), f.write(t, r, e, n, 52, 8), e + 8;
    }
    o.prototype.writeDoubleLE = function(r, e, n) {
      return cr(this, r, e, !0, n);
    }, o.prototype.writeDoubleBE = function(r, e, n) {
      return cr(this, r, e, !1, n);
      ...
      if (typeof r == "number")
        ...
        var E = o.isBuffer(r) ? r : o.from(r, i), v = E.length;
        if (v === 0)
    ...
    function Ur(t) {
      if (t = t.split("=")[0], t = t.trim().replace(Rr, ""), t.length < 2) return "";
      for (; t.length % 4 !== 0; )
        t = t + "=";
      return t;
    }
    function tr(t, r) {
      r = r || 1 / 0;
      for (var e, n = t.length, i = null, a = [], c = 0; c < n; ++c) {
    ...
    function _r(t, r) {
      for (var e, n, i, a = [], c = 0; c < t.length && !((r -= 2) < 0); ++c)
        e = t.charCodeAt(c), n = e >> 8, i = e % 256, a.push(i), a.push(n);
      return a;
    }
    function fr(t) {
      return s.toByteArray(Ur(t));
    }
    function Y(t, r, e, n) {
...
var wr;
function qr() {
  return wr || (wr = 1, (function(u, s) {
    var f = Dr(), h = f.Buffer;
    function m(l, o) {
      for (var x in l)
        o[x] = l[x];
    }
    h.from && h.alloc && h.allocUnsafe && h.allocUnsafeSlow ? u.exports = f : (m(f, s), s.Buffer = d);
    function d(l, o, x) {
      return h(l, o, x);
    }
    d.prototype = Object.create(h.prototype), m(h, d), d.from = function(l, o, x) {
      if (typeof l == "number")
        throw new TypeError("Argument must not be a number");
      return h(l, o, x);
    }, d.alloc = function(l, o, x) {
      if (typeof l != "number")
        throw new TypeError("Argument must be a number");
      var S = h(l);
      return o !== void 0 ? typeof x == "string" ? S.fill(o, x) : S.fill(o) : S.fill(0), S;
      ...
      if (typeof l != "number")
        throw new TypeError("Argument must be a number");
      return f.SlowBuffer(l);
    };
  })(Z, Z.exports)), Z.exports;
}
var gr;
function Nr() {
  if (gr) return K.exports;
  gr = 1;
  var u = 65536, s = 4294967295;
  function f() {
    throw new Error(`Secure random number generation is not supported by this browser.
Use Chrome, Firefox or Internet Explorer 11`);
  }
  var h = qr().Buffer, m = pr.crypto || pr.msCrypto;
  m && m.getRandomValues ? K.exports = d : K.exports = f;
  function d(l, o) {
    if (l > s) throw new RangeError("requested too many random bytes");
    var x = h.allocUnsafe(l);
    if (l > 0)
      if (l > u)
        for (var S = 0; S < l; S += u)
          m.getRandomValues(x.slice(S, S + u));
      else
        m.getRandomValues(x);
...
function Or() {
  if (xr) return or;
  xr = 1;
  var u = Nr(), s = 16, f = C(), h = new RegExp('(\\\\)?"@__(F|R|D|M|S|A|U|I|B|L)-' + f + '-(\\d+)__@"', "g"), m = /\{\s*\[native code\]\s*\}/g, d = /function.*?\(/, l = /.*?=>.*?/, o = /[<>\/\u2028\u2029]/g, x = ["*", "async"], S = {
    "<": "\\u003C",
    ">": "\\u003E",
    "/": "\\u002F",
    "\u2028": "\\u2028",
  ...
  function P(p) {
    var w = [];
    for (var y in p)
      typeof p[y] == "function" && w.push(y);
    for (var B = 0; B < w.length; B++)
      delete p[w[B]];
  }
  return or = function p(w, y) {
    y || (y = {}), (typeof y == "number" || typeof y == "string") && (y = { space: y });
    var B = [], b = [], k = [], L = [], q = [], F = [], j = [], $ = [], H = [], V = [];
    function rr(z, _) {
      if (y.ignoreFunction && P(_), !_ && _ !== void 0 && _ !== BigInt(0))
        return _;
      var g = this[z], R = typeof g;
      if (R === "object") {
        if (g instanceof RegExp)
          return "@__R-" + f + "-" + (b.push(g) - 1) + "__@";
        if (g instanceof Date)
          return "@__D-" + f + "-" + (k.push(g) - 1) + "__@";
        if (g instanceof Map)
          return "@__M-" + f + "-" + (L.push(g) - 1) + "__@";
        if (g instanceof Set)
          return "@__S-" + f + "-" + (q.push(g) - 1) + "__@";
        if (g instanceof Array) {
          var W = g.filter(function() {
            return !0;
          }).length !== g.length;
          if (W)
            return "@__A-" + f + "-" + (F.push(g) - 1) + "__@";
        }
        if (g instanceof URL)
          return "@__L-" + f + "-" + (V.push(g) - 1) + "__@";
      }
      return R === "function" ? "@__F-" + f + "-" + (B.push(g) - 1) + "__@" : R === "undefined" ? "@__U-" + f + "-" + (j.push(g) - 1) + "__@" : R === "number" && !isNaN(g) && !isFinite(g) ? "@__I-" + f + "-" + ($.push(g) - 1) + "__@" : R === "bigint" ? "@__B-" + f + "-" + (H.push(g) - 1) + "__@" : _;
    }
    function er(z) {
      var _ = z.toString();
      if (m.test(_))
        throw new TypeError("Serializing native function: " + z.name);
      if (d.test(_) || l.test(_))
        return _;
      var g = _.indexOf("("), R = _.substr(0, g).trim().split(" ").filter(function(J) {
        return J.length > 0;
      }), W = R.filter(function(J) {
        return x.indexOf(J) === -1;
      });
      return W.length > 0 ? (R.indexOf("async") > -1 ? "async " : "") + "function" + (R.join("").indexOf("*") > -1 ? "*" : "") + _.substr(g) : _;
    }
    if (y.ignoreFunction && typeof w == "function" && (w = void 0), w === void 0)
      return String(w);
    var N;
    return y.isJSON && !y.space ? N = JSON.stringify(w) : N = JSON.stringify(w, y.isJSON ? null : rr, y.space), typeof N != "string" ? String(N) : (y.unsafe !== !0 && (N = N.replace(o, A)), B.length === 0 && b.length === 0 && k.length === 0 && L.length === 0 && q.length === 0 && F.length === 0 && j.length === 0 && $.length === 0 && H.length === 0 && V.length === 0 ? N : N.replace(h, function(z, _, g, R) {
      if (_)
        return z;
      if (g === "D")
        return 'new Date("' + k[R].toISOString() + '")';
      if (g === "R")
        return "new RegExp(" + p(b[R].source) + ', "' + b[R].flags + '")';
      if (g === "M")
        return "new Map(" + p(Array.from(L[R].entries()), y) + ")";
      if (g === "S")
        return "new Set(" + p(Array.from(q[R].values()), y) + ")";
      if (g === "A")
        return "Array.prototype.slice.call(" + p(Object.assign({ length: F[R].length }, F[R]), y) + ")";
      if (g === "U")
        return "undefined";
      if (g === "I")
        return $[R];
      if (g === "B")
        return 'BigInt("' + H[R] + '")';
      if (g === "L")
        return "new URL(" + p(V[R].toString(), y) + ")";
      var W = B[R];
      return er(W);
    }));
  }, or;
...
var zr = Or();
const Er = /* @__PURE__ */ Tr(zr), Fr = "sanity:client", vr = "\0" + Fr;
function Wr(u, s = {}) {
  const f = s.logClientRequests;
  return {
    name: "sanity:client",
    resolveId(h) {
      if (h === Fr)
...
function ar(u) {
  const s = u == null ? void 0 : u.replace(/^\/+|\/+$/g, "");
  return s ? `/${s}` : void 0;
}
function $r(u, s) {
  const f = ar(u);
  if (f)
    return s === "hash" ? f : `${f}/[...params]`;
}
function jr(u) {
  const s = "sanity:studio", f = s;
  return {
    name: "sanity:studio",
    resolveId(h) {
      return h === s ? f : null;
    ...
    async load(h) {
      if (h === s) {
        const m = await this.resolve("/sanity.config");
        if (!m)
          throw new Error(
        ...
        const d = ar(u.studioBasePath);
        if (!d)
          throw new Error(
            "[@sanity/astro]: The `studioBasePath` option cannot be empty. For example — `studioBasePath: '/admin'`"
          );
        const l = u.studioRouterHistory === "hash" ? "hash" : "browser";
        return `
        import studioConfig from "${m.id}";
...
function Hr() {
  const u = "sanity:studio-hash-router", s = u;
  return {
    ...
    async load(f) {
      if (f === u) {
        const h = await this.resolve("/sanity.config");
        if (!h)
          throw new Error(
            "[@sanity/astro]: Sanity Studio requires a `sanity.config.ts|js` file in your project root."
          );
        return `export {default} from "${h.id}";`;
      }
      return null;
    }
  };
...
function Gr(u) {
  ...
  return Jr.some((f) => s.includes(f));
}
function Yr(u) {
  const f = [u.name, u.fileName, u.facadeModuleId, ...u.moduleIds ?? []].filter((h) => typeof h == "string").join(" ");
  return Gr(f);
}
function Xr(u) {
  const s = /* @__PURE__ */ new Set(), f = [];
  for (const h of u.values())
    Yr(h) && f.push(h.fileName);
  for (; f.length > 0; ) {
    const h = f.pop();
    if (!h || s.has(h))
      continue;
    ...
    const m = u.get(h);
    if (m)
      for (const d of [...m.imports ?? [], ...m.dynamicImports ?? []])
        u.has(d) && !s.has(d) && f.push(d);
  }
  return s;
}
function Kr(u, s) {
  const f = s.map((h) => `- ${h}`).join(`
`);
  return `Some chunks are larger than ${u} kB after minification. Consider:
${f}
...
function Zr(u, s) {
  ...
  for (const m of u.values()) {
    if (f.has(m.fileName))
      continue;
    const d = m.code ?? "";
    Buffer.byteLength(d, "utf8") / 1024 > s && h.push(m.fileName);
  }
  return h;
}
function Qr() {
  ...
  return {
    ...
    config(s) {
      var f;
      return typeof ((f = s.build) == null ? void 0 : f.chunkSizeWarningLimit) == "number" && (u = s.build.chunkSizeWarningLimit), {
        build: {
...
function Ir(u, s) {
  try {
    return Ar(Br.join(u, "package.json")).resolve(s), !0;
  } catch {
    return !1;
  }
}
function Sr(u, s) {
  try {
    return Ar(Br.join(u, "package.json")).resolve(`${s}/package.json`).replace(/\/package\.json$/, "");
  } catch {
    return;
  }
}
...
function oe() {
  return {
    ...
    enforce: "pre",
    config(u) {
      const s = u.root ?? process.cwd(), f = ie(s), h = te(s), m = ne(s);
      return {
        optimizeDeps: {
          include: h
        },
...
function ue(u, s) {
  return u === "hash" || u === "browser" ? u : s === "static" ? "hash" : "browser";
}
function fe(u = {}) {
  const s = u.studioBasePath, f = ar(s), h = u.studioRouterHistory, m = u.logClientRequests, d = u;
  if (delete d.studioBasePath, delete d.studioRouterHistory, delete d.logClientRequests, s && s.match(/https?:\/\//))
    throw new Error(
  ...
  return {
    name: "@sanity/astro",
    hooks: {
      "astro:config:setup": ({ config: l, injectScript: o, injectRoute: x, updateConfig: S }) => {
        const A = ue(
          h,
          l == null ? void 0 : l.output
        ), C = [
          ...process.env.SANITY_ASTRO_DISABLE_MODULE_DEDUPE ? [] : [oe()],
          Wr(
            {
              ...ae,
              ...d
